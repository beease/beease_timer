...
export const sendEmail = async (emailTo: string) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <a href="http://localhost:3001/renderVerifyEmail?emailTo=${emailTo}" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #4caf50; color: #ffffff; text-decoration: none; border-radius: 4px;">Confirmer</a>
